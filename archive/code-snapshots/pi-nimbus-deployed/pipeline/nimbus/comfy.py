...
# klein 9B (bf16, gated on Hugging Face) with its 8B text encoder: better composition, and it can spell.
GB10_9B = Profile("gb10-9b", "flux-2-klein-9b.safetensors", "qwen_3_8b_fp4mixed.safetensors")
